...
|---|---|---|
| `HMF-Workbook` | Each team | Mission and scenario, learning objectives, the three dimensions, a **self-check**, a **worked example**, an integrated **product glossary** and jargon decoder, a uniform **HMF product and feature reference** (the whole HMF portfolio; participants identify the fit themselves), the four case studies (generous answer spaces), and a topology page **submitted for SME review**. |
